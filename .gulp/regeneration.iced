...
task 'regenerate', '', (done) ->
  regenExpected {
    ...
    'mappings': {
      ...
      'Microsoft.Compute': { basePath: 'compute/resource-manager', tags: ['package-2020-06-01-only'] },
      'Microsoft.Storage': { basePath: 'storage/resource-manager', tags: ['package-2019-06'] },
      # 'Microsoft.Network': { basePath: 'network/resource-manager', tags: ['package-2020-06'] },
    },
