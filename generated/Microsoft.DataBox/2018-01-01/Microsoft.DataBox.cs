...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_DataBox_2018_01_01
    {
        ...
        private Microsoft_DataBox_2018_01_01()
        {
            ...
            Preferences = new NamedObjectType("Preferences", new ITypeProperty[]{new TypeProperty("preferredDataCenterRegion", new TypedArrayType(LanguageConstants.String), TypePropertyFlags.None)}, null, TypePropertyFlags.None);
