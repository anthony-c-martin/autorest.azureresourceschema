...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_ContainerRegistry_2019_04_01
    {
        ...
        private Microsoft_ContainerRegistry_2019_04_01()
        {
            ...
            TriggerProperties = new NamedObjectType("TriggerProperties", new ITypeProperty[]{new TypeProperty("timerTriggers", new TypedArrayType(new NamedObjectType("timerTriggers", new ITypeProperty[]{}, null, TypePropertyFlags.None)), TypePropertyFlags.None), new TypeProperty("sourceTriggers", new TypedArrayType(new NamedObjectType("sourceTriggers", new ITypeProperty[]{}, null, TypePropertyFlags.None)), TypePropertyFlags.None), new LazyTypeProperty("baseImageTrigger", () => BaseImageTrigger, TypePropertyFlags.None)}, null, TypePropertyFlags.None);
