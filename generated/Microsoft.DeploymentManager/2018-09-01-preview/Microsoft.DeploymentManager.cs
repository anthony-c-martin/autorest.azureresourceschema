...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_DeploymentManager_2018_09_01_preview
    {
        ...
        private Microsoft_DeploymentManager_2018_09_01_preview()
        {
            ...
            Identity = new NamedObjectType("Identity", new ITypeProperty[]{new TypeProperty("type", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("identityIds", new TypedArrayType(LanguageConstants.String), TypePropertyFlags.Required)}, null, TypePropertyFlags.None);
            RolloutRequestProperties = new NamedObjectType("RolloutRequestProperties", new ITypeProperty[]{new TypeProperty("buildVersion", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("artifactSourceId", LanguageConstants.String, TypePropertyFlags.None), new TypeProperty("targetServiceTopologyId", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("stepGroups", new TypedArrayType(new NamedObjectType("stepGroups", new ITypeProperty[]{}, null, TypePropertyFlags.None)), TypePropertyFlags.Required)}, null, TypePropertyFlags.None);
            Step = new NamedObjectType("Step", new ITypeProperty[]{new TypeProperty("name", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("dependsOnStepGroups", new TypedArrayType(LanguageConstants.String), TypePropertyFlags.None), new TypeProperty("preDeploymentSteps", new TypedArrayType(new NamedObjectType("preDeploymentSteps", new ITypeProperty[]{}, null, TypePropertyFlags.None)), TypePropertyFlags.None), new TypeProperty("deploymentTargetId", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("postDeploymentSteps", new TypedArrayType(new NamedObjectType("postDeploymentSteps", new ITypeProperty[]{}, null, TypePropertyFlags.None)), TypePropertyFlags.None)}, null, TypePropertyFlags.None);
