...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_Peering_2019_08_01_preview
    {
        ...
        private Microsoft_Peering_2019_08_01_preview()
        {
            ...
            ContactInfo = new NamedObjectType("ContactInfo", new ITypeProperty[]{new TypeProperty("emails", new TypedArrayType(LanguageConstants.String), TypePropertyFlags.None), new TypeProperty("phone", new TypedArrayType(LanguageConstants.String), TypePropertyFlags.None)}, null, TypePropertyFlags.None);
            ...
            PeeringPropertiesExchange = new NamedObjectType("PeeringPropertiesExchange", new ITypeProperty[]{new TypeProperty("connections", new TypedArrayType(new NamedObjectType("connections", new ITypeProperty[]{}, null, TypePropertyFlags.None)), TypePropertyFlags.None), new LazyTypeProperty("peerAsn", () => SubResource, TypePropertyFlags.None)}, null, TypePropertyFlags.None);
