...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_Attestation_2018_09_01_preview
    {
        ...
        private Microsoft_Attestation_2018_09_01_preview()
        {
            ...
            JSONWebKeySet = new NamedObjectType("JSONWebKeySet", new ITypeProperty[]{new TypeProperty("keys", new TypedArrayType(new NamedObjectType("keys", new ITypeProperty[]{}, null, TypePropertyFlags.None)), TypePropertyFlags.None)}, null, TypePropertyFlags.None);
